          ...
          <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='text-center'>
              <h1 className='text-4xl md:text-6xl font-light text-[#0a0a0a] leading-tight mb-6'>
                AskLaw LM <span className='font-normal'>Draft</span>
              </h1>
              <p className='text-xl text-[#6b6b6b] mb-8 max-w-3xl mx-auto leading-relaxed'>
                Your intelligent legal reasoning assistant for document drafting, 
                review, and analysis with AI-powered legal expertise.
              </p>
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            ...
            <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
              ...
              <div className='p-6 rounded-lg border border-gray-100 hover:shadow-lg transition-shadow'>
                ...
                <h3 className='text-xl font-semibold text-[#0a0a0a] mb-2'>AI-Powered Drafting</h3>
              ...
              <div className='p-6 rounded-lg border border-gray-100 hover:shadow-lg transition-shadow'>
                ...
                <h3 className='text-xl font-semibold text-[#0a0a0a] mb-2'>Intelligent Review</h3>
                <p className='text-[#6b6b6b] mb-4'>
                  Comprehensive document analysis with risk assessment, 
                  clause optimization, and compliance checking.
                </p>
                <ul className='text-sm text-[#6b6b6b] space-y-2'>
                  <li className='flex items-center gap-2'>
                    <CheckCircle className='h-4 w-4 text-green-500' />
              ...
              <div className='p-6 rounded-lg border border-gray-100 hover:shadow-lg transition-shadow'>
                ...
                <h3 className='text-xl font-semibold text-[#0a0a0a] mb-2'>Legal Reasoning Engine</h3>
                <p className='text-[#6b6b6b] mb-4'>
              ...
              <div className='p-6 rounded-lg border border-gray-100 hover:shadow-lg transition-shadow'>
                ...
                <h3 className='text-xl font-semibold text-[#0a0a0a] mb-2'>Smart Revisions</h3>
                <p className='text-[#6b6b6b] mb-4'>
              ...
              <div className='p-6 rounded-lg border border-gray-100 hover:shadow-lg transition-shadow'>
                ...
                <h3 className='text-xl font-semibold text-[#0a0a0a] mb-2'>Quality Control</h3>
                <p className='text-[#6b6b6b] mb-4'>
                  Automated quality checks, consistency verification, 
                  and best practice recommendations for professional documents.
                </p>
                <ul className='text-sm text-[#6b6b6b] space-y-2'>
                  <li className='flex items-center gap-2'>
                    <CheckCircle className='h-4 w-4 text-green-500' />
              ...
              <div className='p-6 rounded-lg border border-gray-100 hover:shadow-lg transition-shadow'>
                ...
                <h3 className='text-xl font-semibold text-[#0a0a0a] mb-2'>Secure Environment</h3>
                <p className='text-[#6b6b6b] mb-4'>
        ...
        <section className='py-20 bg-slate-50'>
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='text-center mb-16'>
              ...
              <p className='text-lg text-[#6b6b6b] max-w-2xl mx-auto'>
                Enhance your document quality while reducing drafting time with AI assistance.
              </p>
            </div>
            ...
            <div className='grid md:grid-cols-3 gap-8'>
              <div className='text-center'>
                ...
                <h3 className='text-2xl font-semibold text-[#0a0a0a] mb-2'>60% Faster Drafting</h3>
                <p className='text-[#6b6b6b]'>
                  Accelerate document creation with AI-powered drafting assistance.
                </p>
              </div>
              ...
              <div className='text-center'>
                ...
                <h3 className='text-2xl font-semibold text-[#0a0a0a] mb-2'>85% Fewer Errors</h3>
                <p className='text-[#6b6b6b]'>
                  Reduce mistakes with intelligent review and quality control systems.
                </p>
              </div>
              ...
              <div className='text-center'>
                ...
                <h3 className='text-2xl font-semibold text-[#0a0a0a] mb-2'>Higher Quality</h3>
                <p className='text-[#6b6b6b]'>
        ...
        <section className='py-20'>
          <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
            ...
            <p className='text-lg text-[#6b6b6b] mb-8 max-w-2xl mx-auto'>
              ...
              capabilities with AskLaw LM Draft.
            </p>
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <Button 
                size='lg' 
