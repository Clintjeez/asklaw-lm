          ...
          <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='text-center'>
              <h1 className='text-4xl md:text-6xl font-light text-[#0a0a0a] leading-tight mb-6'>
                AskLawLM <span className='font-normal'>Ops</span>
              </h1>
              <p className='text-xl text-[#6b6b6b] mb-8 max-w-3xl mx-auto leading-relaxed'>
                Streamline your legal practice with intelligent workspace
                management, client operations, and automated workflows designed
                for modern legal praticing.
              </p>
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='text-center mb-16'>
              ...
              <p className='text-lg text-[#6b6b6b] max-w-2xl mx-auto'>
                From client management to billing automation, AskLaw LM Ops
                provides a comprehensive workspace for legal professionals.
              </p>
            </div>
            ...
            <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
              ...
              <div className='p-6 rounded-lg border border-gray-100 hover:shadow-lg transition-shadow'>
                ...
                <p className='text-[#6b6b6b] mb-4'>
                  Centralized client database with contact information, case
                  history, and communication tracking.
                </p>
              ...
              <div className='p-6 rounded-lg border border-gray-100 hover:shadow-lg transition-shadow'>
                ...
                <p className='text-[#6b6b6b] mb-4'>
                  Automated time tracking, expense management, and streamlined
                  billing processes.
                </p>
                <ul className='text-sm text-[#6b6b6b] space-y-2'>
                  <li className='flex items-center gap-2'>
              ...
              <div className='p-6 rounded-lg border border-gray-100 hover:shadow-lg transition-shadow'>
                ...
                <p className='text-[#6b6b6b] mb-4'>
                  Bank-level security with built-in compliance tools for legal
        ...
        <section className='py-20 bg-slate-50'>
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='text-center mb-16'>
              ...
              <p className='text-lg text-[#6b6b6b] max-w-2xl mx-auto'>
                See measurable improvements in efficiency, client satisfaction,
                and profitability.
              </p>
            </div>
            ...
            <div className='grid md:grid-cols-3 gap-8'>
              <div className='text-center'>
                ...
                <p className='text-[#6b6b6b]'>
                  Average revenue growth through improved billing accuracy and
                  time tracking.
                </p>
              </div>
              ...
              <div className='text-center'>
                ...
                <p className='text-[#6b6b6b]'>
                  Reduce administrative overhead with automated workflows and
                  processes.
                </p>
              </div>
              ...
              <div className='text-center'>
                ...
                <p className='text-[#6b6b6b]'>
                  Deliver exceptional client experience with streamlined
