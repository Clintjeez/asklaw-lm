          ...
          <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
            <div className='space-y-8'>
              ...
              <p className='text-xl md:text-2xl text-[#6b6b6b] font-light max-w-3xl mx-auto leading-relaxed'>
                Simple, transparent pricing for legal professionals. Choose the
                perfect plan for your practice with enterprise-grade security
                included.
              </p>
            ...
            <div className='grid lg:grid-cols-3 gap-8'>
              ...
              <div className='bg-white rounded-2xl border-2 border-[#0a0a0a] p-8 relative hover:shadow-lg transition-shadow'>
                ...
                <div className='flex items-center gap-3 mb-6 mt-2'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-[#6b6b6b]'>
                      Ideal for small to medium firms
                    </p>
                  </div>
                </div>
              ...
              <div className='bg-white rounded-2xl border border-gray-200 p-8 hover:shadow-lg transition-shadow'>
                ...
                <div className='mb-6'>
                  ...
                  <p className='text-sm text-[#6b6b6b] mt-1'>
                    Billed annually or $180/month
                  </p>
                </div>

                <Button
                  variant='outline'
                  className='w-full border-[#0a0a0a] text-[#0a0a0a] hover:bg-gray-50 mb-6'
                >
                  Contact Sales
                </Button>
          ...
          <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8'>
            ...
            <Accordion type='single' collapsible className='w-full space-y-4'>
              ...
              >
                ...
                <AccordionContent className='px-6 pb-4'>
                  <p className='text-[#6b6b6b]'>
                    ...
                    card required to start. You'll have full access to all
              ...
              >
                ...
                <AccordionContent className='px-6 pb-4'>
                  <p className='text-[#6b6b6b]'>
                    ...
                    Express) and can arrange bank transfers for Enterprise
                    customers.
                  </p>
                </AccordionContent>
              </AccordionItem>
              ...
              >
                ...
                <AccordionContent className='px-6 pb-4'>
                  <p className='text-[#6b6b6b]'>
                    Yes, all plans include a discount when paid annually. You'll
                    save approximately 20% compared to monthly billing.
                  </p>
                </AccordionContent>
              </AccordionItem>
              ...
              >
                ...
                <AccordionContent className='px-6 pb-4'>
                  <p className='text-[#6b6b6b]'>
                    ...
                    end-to-end encryption, SOC 2 compliance, and comprehensive
                    audit trails. Your data is always protected.
                  </p>
                </AccordionContent>
              </AccordionItem>
            </Accordion>
