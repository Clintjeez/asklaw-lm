...
const Sidebar = ({ userEmail }: SidebarProps) => {
  ...
  const navigationItems = [
    ...
    { icon: Columns4, label: 'Cases', path: '/cases', active: false },
    { icon: UsersRound, label: 'Clients', path: '/clients', active: false },
  ];
          ...
          {!isCollapsed && (
            <div className='flex items-center gap-1'>
              ...
              <div className='bg-gray-100 p-3 rounded-full'>
                <p className='font-semibold text-[17px]'>CJ</p>
              </div>
              <div>
                <p className='px-2'>Clinton James</p>
                <div className='flex text-[#7f7f7f] text-[14px] font-light'>
                  <DropdownMenu>
                    <DropdownMenuTrigger className='flex gap-1 hover:bg-gray-100 py-1 px-2 rounded-md'>
                      <p className='text-[#7f7f7f] text-[14px] font-light'>
                        Alubasa workspace
                      </p>
                      <ChevronsDown className='text-[10px] w-4' />
                    </DropdownMenuTrigger>
