...
const ChatArea = ({
  ...
  const hasProcessedSource =
    sources?.some((source) => source.processing_status === 'completed') ||
    false;
    ...
    <div className='flex-1 flex flex-col h-full overflow-hidden'>
                ...
                {(messages.length > 0 ||
                  ...
                  <div className='mb-6 space-y-4'>
                    {messages.map((msg, index) => (
                      ...
                      >
                        <div
                          className={`${isUserMessage(msg) ? 'max-w-xs lg:max-w-md px-4 py-2 bg-blue-500 text-white rounded-lg' : 'w-full'}`}
                        >
                          <div
                            className={
                              isUserMessage(msg)
                                ? ''
                                : 'prose prose-gray max-w-none text-gray-800'
                            }
                          >
                            <MarkdownRenderer
                    ...
                    {!showAiLoading && shouldShowScrollTarget() && (
              ...
              <div className='flex space-x-4'>
                <div className='flex-1 relative'>
                  <Input
                    ...
                    className='pr-12'
                    disabled={
                      isChatDisabled || isSending || !!pendingUserMessage
                    }
                  />
      ...
      <div className='p-4 border-t border-gray-200 flex-shrink-0'>
        <p className='text-center text-sm text-gray-500'>
          AskLawLM can be inaccurate; please double-check its responses.
        </p>
      </div>
