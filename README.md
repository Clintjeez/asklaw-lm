<p align="center">
  <img src="https://www.theaiautomators.com/wp-content/uploads/2025/07/Group-2651.svg" alt="AsklawLM Logo" width="600"/>
</p>


# AsklawLM: The Open Source NotebookLM Alternative

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![GitHub stars](https://img.shields.io/github/stars/theaiautomators/asklaw-lm-public?style=social)](https://github.com/theaiautomators/asklaw-lm-public/stargazers)
...
That's exactly what we've done with **AsklawLM**. This project is an open-source, self-hostable alternative to NotebookLM. It's designed to be a powerful AI research tool that grounds its responses exclusively in the sources you provide, making it a reliable window into your company's knowledge base.


## About The Project

NotebookLM is one of the most powerful AI research tools available today. However, its closed-source nature limits its potential for customization and private hosting. AsklawLM was created to bridge this gap.
...
This version of AsklawLM relies on cloud AI services like OpenAI and Gemini.
...
[Fully Local AsklawLM](https://github.com/theaiautomators/asklaw-lm-local-package)

## Join Our Community

If you're interested in learning how to customize AsklawLM or build similar applications, join our community, The AI Automators.
...
For a complete demonstration of AsklawLM, an overview of its architecture, and a step-by-step guide on how to set it up, check out our YouTube video:
...
This guide provides the quickest way to get AsklawLM up and running so you can test, customize, and experiment.
...
2.  **Create GitHub Account & Repo from Template**
    ...
    * Navigate to the AsklawLM template repository here: [**github.com/theaiautomators/asklaw-lm-public**](https://github.com/theaiautomators/asklaw-lm-public)
...
4.  **Import and Configure N8N Workflows**
    * The `/n8n` directory in this repository contains the JSON files for the required N8N workflows. There are 2 approaches here.
        1. The easiest is to import the "Import_Asklaw_LM_Workflows.json" file into a new workflow in n8n and follow the steps in the video. This includes configuring an n8n API key which will be used to auto-create all workflows needed by the system. You will also need to set various credentials.
...
6.  **Test & Customize**
    * That's it! Your instance of AsklawLM should now be live.
...
While AsklawLM is fully open-sourced and Supabase is also open source, it's important to be aware that n8n, which powers much of the backend automation, is not open source in the traditional sense.
...
However, if you plan to use AsklawLM as part of a commercial SaaS offering—such as reselling access or hosting a public version for multiple clients—you may need to obtain an n8n Enterprise License. We're not lawyers, so we recommend that you review the n8n license and contacting their team if your use case falls into a commercial category.
